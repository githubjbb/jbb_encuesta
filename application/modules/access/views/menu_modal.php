...
<div class="modal-body">
	<form name="form" id="form" role="form" method="post" >
		...
		<div class="row">
			<div class="col-sm-6">		
				<div class="form-group text-left">
					<label class="control-label" for="menu_status">Estado: *</label>
					<select name="menu_status" id="menu_status" class="form-control" required>
						<option value=''>Seleccione...</option>
						<option value=1 <?php if($information && $information[0]["menu_status"] == 1) { echo "selected"; }  ?>>Activo</option>
						<option value=2 <?php if($information && $information[0]["menu_status"] == 2) { echo "selected"; }  ?>>Inactivo</option>
					</select>
				</div>
			</div>
