			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<input type="hidden" id="hddId" name="hddId" value="<?php echo $information?$information[0]["id_link"]:""; ?>"/>
						...
						<div class="form-group">
							<label class="col-sm-4 control-label" for="link_status">Estado: *</label>
							<div class="col-sm-5">
								<select name="link_status" id="link_status" class="form-control" required>
									<option value=''>Select...</option>
									<option value=1 <?php if($information && $information[0]["link_status"] == 1) { echo "selected"; }  ?>>Activo</option>
									<option value=2 <?php if($information && $information[0]["link_status"] == 2) { echo "selected"; }  ?>>Inactivo</option>
								</select>
							</div>
						</div>
