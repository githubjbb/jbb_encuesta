			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<ul class="nav nav-pills">
						<li <?php if($status == 1){ echo "class='active'";} ?>><a href="<?php echo base_url("settings/users"); ?>">Usuarios Activos</a>
						</li>
						<li <?php if($status == 2){ echo "class='active'";} ?>><a href="<?php echo base_url("settings/users/2"); ?>">Usuarios Inactivos</a>
						</li>
					</ul>
					<br>	
