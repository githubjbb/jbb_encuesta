...
<div class="modal-header">
	...
	<h4 class="modal-title" id="exampleModalLabel">Buscar Encuestas x Fecha</h4>
</div>

<div class="modal-body">
	<form name="form" id="form" role="form" method="post" action="<?php echo base_url('dashboard/buscar_encuestas_percepcion'); ?>">
